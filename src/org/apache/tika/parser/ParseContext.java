...
public class ParseContext implements Serializable {
	 ...
	 * @return the object that implements the given interface, or <code>null</code>
	 *         if not found
	 */
	...
	/**
	 * Returns the object in this context that implements the given interface, or
	 * the given default value if such an object is not found.
	 *
	 * @param key          the interface implemented by the requested object
	 * @param defaultValue value to return if the requested object is not found
	 * @return the object that implements the given interface, or the given default
	 *         value if not found
	 */
	...
	/**
	 * Returns the SAX parser specified in this parsing context. If a parser is not
	 * explicitly specified, then one is created using the specified or the default
	 * SAX parser factory.
	 *
